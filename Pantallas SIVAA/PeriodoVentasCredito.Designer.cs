...
{
    partial class PeriodoVentasCredito
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // 
            ndan.Enabled = false;
            ndan.Location = new Point(317, 84);
            ...
            nddia2.Location = new Point(50, 142);
            ...
            // 
            ndmes.Enabled = false;
            ndmes.Location = new Point(187, 84);
            ...
            // 
            nddia.Enabled = false;
            nddia.Location = new Point(50, 84);
            ...
            button1.Location = new Point(187, 205);
            ...
            comboBox1.Location = new Point(346, 16);
            comboBox1.Name = "comboBox1";
            comboBox1.Size = new Size(151, 28);
            comboBox1.TabIndex = 13;
            comboBox1.SelectedIndexChanged += comboBox1_SelectedIndexChanged;
            // 
            // PeriodoVentasCredito
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(547, 279);
            Controls.Add(ndan);
            Controls.Add(nddia2);
            Controls.Add(ndmes);
            Controls.Add(nddia);
            ...
            Name = "PeriodoVentasCredito";
            Text = "PeriodoVentasCredito";
            Load += PeriodoVentasCredito_Load;
