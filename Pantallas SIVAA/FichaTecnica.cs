...
namespace Pantallas_SIVAA
{
    public partial class FichaTecnica : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            document.DefaultPageSettings.Margins = new Margins(50, 50, 50, 50); // 2.5cm margins on each side
            document.DefaultPageSettings.PaperSize = new PaperSize("Letter", 816,1056); // Swap the paper width and height
